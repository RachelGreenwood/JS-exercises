...
// num2 but not num1?
// The rules for num2 are inclusive, the rules for num1 are exclusive (arr2 includes 1 and 10, arr1 does not). num2 could use any number 1-10, num1 could use the numbers 2-9.
...
let statement = "Hi, name is " + myName + ", and I can't wait to visit " + dreamDestination + "!";
