...
function exercise1(num1) {
  ...
  // varA and varB may seem equal but would not pass the tests if they were not exactly the same data type (e.g. varA = '7' and varB = 7), or if the data types were not alphanumerical (e.g. varA = ! and varB = !)
